...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-2639f8db7df9b47e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-fa3a41cc3b92dade.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![多继承](https://upload-images.jianshu.io/upload_images/21580557-749766d1977799ae.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![桥接模式](https://upload-images.jianshu.io/upload_images/21580557-bb77963ae3729178.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)



**优点：**
- 桥接模式类似于多继承方案，但是多继承方案违背了类的单一职责原则，复用性比较差，类的个数也非常多。桥接模式使用组合替代继承，可以极大减少子类的个数，降低管理和维护成本。
- 桥接模式提高了系统的可扩充性，把两个变化维度中任意扩展一个维度都不需要修改原有系统。复合开闭原则，把两个变化的维度连接起来。
...
缺点：
- 一个真实角色就会产生一个代理角色；代码量会翻倍，开发效率变低。（使用动态代理解决）
**接口类**
```java
...
public class Proxy implements Rentable {
    ...
    public Proxy(Rentable rentable){
