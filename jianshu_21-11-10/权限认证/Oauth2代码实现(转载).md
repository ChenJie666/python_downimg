...
![启动服务.png](https://upload-images.jianshu.io/upload_images/21580557-35a55036244a3003.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

*  使用密码模式获取JWT令牌，访问地址：http://localhost:9201/auth/oauth/token
![获取JWT令牌.png](https://upload-images.jianshu.io/upload_images/21580557-5b5e05420691e200.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

*  使用获取到的JWT令牌访问需要权限的接口，访问地址：http://localhost:9201/api/hello![访问权限接口.png](https://upload-images.jianshu.io/upload_images/21580557-1b7b9372b0d9b9c5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

*  使用获取到的JWT令牌访问获取当前登录用户信息的接口，访问地址: http://localhost:9201/api/user/currentUser
![访问用户接口.png](https://upload-images.jianshu.io/upload_images/21580557-d8d9d1e5c71b1d04.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

*  当JWT令牌过期时，使用refresh_token获取新的JWT令牌，访问地址：http://localhost:9201/auth/oauth/token
![刷新token.png](https://upload-images.jianshu.io/upload_images/21580557-d83f95a57d7e5526.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

*  使用没有访问权限的andy账号登录，访问接口时会返回如下信息，访问地址：http://localhost:9201/api/hello
![无权限访问](https://upload-images.jianshu.io/upload_images/21580557-5d791cb004289a98.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
