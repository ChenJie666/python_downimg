...
![线程状态图](https://upload-images.jianshu.io/upload_images/21580557-a1f4fa9a6cf48f2f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![COW源码](https://upload-images.jianshu.io/upload_images/21580557-e5881f4284d6ab5b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-e43b41ce2e6e831c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![java开发规约](https://upload-images.jianshu.io/upload_images/21580557-1b272c536d04dcaf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-718ace33fb6d257d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

**ForkJoin特点：**
- 分治思想
- 工作窃取：维护双端队列，每个小规模里面的问题解决完之后，会从别的地方后面拿取处理完成并归还。

![image.png](https://upload-images.jianshu.io/upload_images/21580557-32fb6a15887fcb67.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-0bf3b95f858dd4ed.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-02bce1e2356ed437.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
### 12.3.4 多任务组合关系
#### 12.3.4.1 AND
![image.png](https://upload-images.jianshu.io/upload_images/21580557-11f2e073c048564a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
## 13.3 共享变量的八种操作
![image.png](https://upload-images.jianshu.io/upload_images/21580557-8fddf28315cd92f5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
>如果是原子操作，那么最后的值为10000，但是实际打印经常小于10000。因为`num++不是原子操作`，导致多线程情况下产生并发问题；volatile无法改变操作的原子性。![方法底层操作步骤：获取值、加一、写回值](https://upload-images.jianshu.io/upload_images/21580557-b5f164f2416edfe8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
>- 可以通过加锁来解决；
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-4294924b8ebc2e54.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
>如果对枚举类使用反射构造对象，会抛出`throw new IllegalArgumentException("Cannot reflectively create enum objects")`;![反射调用构造器方法部分源码](https://upload-images.jianshu.io/upload_images/21580557-1c2ce4e42d8a6ce9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
>
>但是当我们通过反射调用无参构造器时抛出异常为NoSuchMethodException；因此通过javap -p xxx.class反编译字节码得到源码如下![反编译源码](https://upload-images.jianshu.io/upload_images/21580557-5869a9f02702c393.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
>
...
CAS比较与交换的伪代码可以表示为：![image.png](https://upload-images.jianshu.io/upload_images/21580557-8b2c4d234de07d7e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image](https://upload-images.jianshu.io/upload_images/21580557-7d2f0997c0db3313.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-9036e5d91d5395e3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
