...
![image.png](https://upload-images.jianshu.io/upload_images/21580557-464a762af509c755.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


###权限配置
权限配置分为两部分：
- 管理角色：角色又分为全局角色(Global roles)和项目角色(Item roles)。全局角色中的权限对全局都有效，项目角色中的权限会匹配对应的项目并分配相应的权限。![image.png](https://upload-images.jianshu.io/upload_images/21580557-2261f6aff61457dd.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
- 分配角色 ：需要给用户分配全局角色，如果想实现对项目的精细化控制，需要再分配一个项目角色。![image.png](https://upload-images.jianshu.io/upload_images/21580557-cafa2ac9cc69dbe7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
