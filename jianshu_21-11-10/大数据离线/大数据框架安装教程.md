...
![](http://upload-images.jianshu.io/upload_images/21580557-4059d86f94afcd4c.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1080/q/50)
...
1. 需要在hive的hive-env.sh中引入tez的所有jar包。
   ...
   export HIVE_AUX_JARS_PATH=$HADOOP_HOME/share/hadoop/common/hadoop-lzo-0.4.20.jar$TEZ_JARS,/opt/module/hadoop-2.7.2/share/hadoop/common/hadoop-lzo-0.4.20.jar$TEZ_JARS
   ```
...
1. 解压tez压缩包到hive所在的节点上，在tez的tez-site.xml中配置hdfs上。
...
![21580557-6dc93d42eb0cf7d0.png](https://upload-images.jianshu.io/upload_images/21580557-1578ac1a4a053914.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
| Spark-session |  YarnCoarseGrainedExecutorBackend |
